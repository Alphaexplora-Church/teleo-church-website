...
export function ConfirmDeleteModal({ open, contentTitle, onCancel, onConfirm }: ConfirmDeleteModalProps) {
    if (!open) return null;
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-8 text-center">
                ...
                <h3 className="font-serif text-xl text-midnight-teal mb-2">Archive Content?</h3>
                <p className="text-sm text-gray-500 mb-6">
                    “<span className="font-semibold text-gray-700">{contentTitle}</span>” will be removed from the public site and moved to the archive.
                </p>
